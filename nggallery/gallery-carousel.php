...
<div class="ngg-galleryoverview">
	...
	<div class="pic"><a class="ngg-browser-next" id="ngg-next-<?php echo $current->pid ?>" href="<?php echo $current->pidlink ?>">
		<img title="<?php echo $current->alttext ?>" alt="<?php echo $current->alttext ?>" src="<?php echo $current->imageURL; ?>" /></a></div>
