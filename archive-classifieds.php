	...
	<aside class="span4" id="sidebar" role="complementary">
		<div id="sidebar-inside">
			...
			<div id="place-ad">
				...
				<div class="side-info">
					<a href="http://adpro.media.ucla.edu/online" class="btn btn-inverse classifieds-button" target="_blank">Place an ad &raquo;</a>
					<div class="btn-group classifieds-button-group">
						<a href="http://dailybruin.com/images/ads/classifieds_rates.pdf" class="btn classifieds-button-small"><i class="icon-tasks"></i> Rates</a>
						<a href="http://dailybruin.com/images/ads/classifieds_calendar.pdf" class="btn classifieds-button-small"><i class="icon-calendar"></i> Publication calendar</a>
