<?php/*
Template Name: A&E Ralph Series
*/ ?>
<?php get_header(); ?>
...
<div class="tabs full-width">
  ...
  <div id="tab-content2" class="tab-content">
    <!-- TITLE -->
    <div class="row tab-title tab-title2 full-width">
      <div class="large-6 columns">
      </div>
    ...
    <div class="row image-snippet full-width">
      ...
      <div class="large-6 columns">
        <h3 class="small-picture-title">
          Melendez aspires to own a bakery attached to a flower shop to cater to weddings and other special occasions.
        </h3>
      </div>
    </div>
  ...
  <div id="tab-content3" class="tab-content">
    <!-- TITLE -->
    <div class="row tab-title tab-title3 full-width">
      <div class="large-6 columns">
      </div>
    ...
    <div class="row image-snippet full-width">
      ...
      <div class="large-6 columns">
        <h3 class="small-picture-title">
          Timothy Kauthen, a Ralphs employee since April, said he has dreamed of becoming a musical performer.
        </h3>
      </div>
    </div>
