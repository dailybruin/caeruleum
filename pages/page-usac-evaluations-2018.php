<?php/*
Template Name: USAC Evaluations 2018
*/ ?>
...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
        <div class="usac-eval-2015" >
            <h2 class="title">2017-2018 USAC Officer Evaluations</h2>
            <p><?php the_content(); ?></p>
...
$(function showstones() {
$.getJSON( "https://spreadsheets.google.com/feeds/list/13Zq_6AWNc3EdGQEr_z7lVZ3PQmfDkVW-uqYSIM6gUsE/od6/public/values?alt=json",
